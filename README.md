...
```javascript
imag = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-imag@v0.1.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/complex-float32-imag/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/complex-float32-imag/actions/workflows/test.yml?query=branch:v0.1.2
